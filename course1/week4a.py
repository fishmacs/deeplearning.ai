import numpy as np
from course1.dnn_utils_v2 import sigmoid, sigmoid_backward, relu, relu_backward
...
def L_model_forward(X, parameters):
    ...
    for l in range(1, L + 1):
        A_prev = A
        activation = l < L and 'relu' or 'sigmoid'
...
def linear_activation_backward(dA, cache, activation):
    ...
    if activation == "relu":
        ...
        raise Exception('Invalid activation argument: ' + activation)
